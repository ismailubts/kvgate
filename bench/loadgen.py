#!/usr/bin/env python3
"""kvgate load generator — asyncio Poisson-arrival OpenAI-compatible client.

Drives an OpenAI /v1/chat/completions endpoint (kvgate, or a backend directly)
...
def main():
    ap = argparse.ArgumentParser(description="kvgate Poisson-arrival load generator")
    ...
    print("=" * 72)
    print(f"kvgate loadgen summary {('— ' + args.label) if args.label else ''}")
    print(
